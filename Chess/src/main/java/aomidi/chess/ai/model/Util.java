...
public class Util {
    ...
    public static String intToLetter(int file) {
        switch (file) {
            ...
            case 8:
                return "H";
            default:
                throw new IllegalArgumentException("Illegal file number: " + file);
        }
    }
    ...
    public static int letterToInt(String file) {
        ...
        switch (file) {
            ...
            case "H":
                return 8;
            default:
                throw new IllegalArgumentException("Illegal file letter: " + file);
        }
    }
    ...
    public static String getTypeLetter(PieceType type) {
        switch (type) {
            ...
            case King:
                return "K";
            default:
                throw new IllegalArgumentException("Illegal PieceType: " + type);
        }
    }

    public static String getTypeLetter(PieceType type, Color color) {
    ...
    public static PieceType getPieceType(String piece) {
        ...
        switch (piece) {
            ...
            default:
                throw new IllegalArgumentException("Illegal Input: " + piece);
        }
    }
